...
const connectRetry = t => {
  ...
  return connect(`mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@employeehq-${process.env.NODE_ENV === 'development' ? 'dev-' : ''}cluster.mpssn.mongodb.net/sproud${process.env.NODE_ENV === 'development' ? '-dev' : ''}?retryWrites=true&w=majority`, {
